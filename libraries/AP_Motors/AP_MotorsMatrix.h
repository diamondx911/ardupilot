...
protected:
    ...
    void 				add_motor_raw_6dof(int8_t motor_num, float forward_fac, float lat_fac, float pitch_fac, float roll_fac, float yaw_fac, uint8_t testing_order);
    ...
    float               _forward_factor[AP_MOTORS_MAX_NUM_MOTORS]; // each motors contribution to pitch
    float               _lateral_factor[AP_MOTORS_MAX_NUM_MOTORS]; // each motors contribution to pitch
